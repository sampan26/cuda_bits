...
output_v3a = module.matmul_v3a(input1, input2)
output_v3b = module.matmul_v3b(input1, input2)
...
print("v3a:", benchmark(module.matmul_v3a, input1, input2))
print("v3b:", benchmark(module.matmul_v3b, input1, input2))